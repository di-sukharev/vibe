...
Playwright проверяет важные успешные сценарии через настоящий интерфейс и backend по [правилам тестирования](../AGENTS.md#тестирование-и-проверка). Запускай браузер только по явному запросу.
