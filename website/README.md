...
4. Deploy this surface as an App Platform **service** (a runtime container, like the backend in [../.do/api-app.yaml.example](../.do/api-app.yaml.example)) instead of a Static Site, since SSR routes need the Node server at runtime.
